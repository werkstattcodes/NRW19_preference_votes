...
saveWidget(x,
  file = "party_prefence_share_by_state.html",
  selfcontained = T,
  background = "white"
)
...
saveWidget(x,
  file = "plot_interactive_n_mandates.html",
  background = "white"
)
...
saveWidget(x,
  file = "candidate_vote_share_by_list.html",
  background = "white"
)
